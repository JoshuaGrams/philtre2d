...
local stats = require("lib.luacov.stats")
local util = require("lib.luacov.util")
runner.defaults = require("lib.luacov.defaults")
...
-- end
-- @function debug_hook
runner.debug_hook = require(cluacov_ok and "cluacov.hook" or "lib.luacov.hook").new(runner)
...
function runner.run_report(configuration)
   ...
   local reporter = "lib.luacov.reporter"
