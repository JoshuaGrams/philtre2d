...
return {
	...
	function(scene) -- Homogeneous Column
		...
		T.has(ch1, {h=50}, "Homogeneous alloc to small child is correct.")
		T.has(ch2, {h=50}, "Homogeneous alloc to large child is correct.")
		local ch3 = scene:add(Node(10, 30, nil, nil, "none", "fill"), col)
		T.has(ch1, {h=100/3}, "Homogeneous alloc to small child after adding new child is correct.")
		T.has(ch2, {h=100/3}, "Homogeneous alloc to large child after adding new child is correct.")
		T.has(ch3, {h=100/3}, "Homogeneous alloc to medium child after adding new child is correct.")
		scene:remove(ch1)
		scene:remove(ch3)
