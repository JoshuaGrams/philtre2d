...
return {
	...
	function(scene)
		...
		local s = scene:add(Slice(img, nil, {1, 2, 3, 4}, 20, 20, "NW", "C")) -- lt, rt, top, bot
	...
	function(scene)
		...
		local s = scene:add(Slice(img, nil, {2}, 20, 20, "NW", "C", "stretch", "stretch")) -- lt, rt, top, bot
		s:allocate(0, 0, 20, 20, 20, 20, 2)
